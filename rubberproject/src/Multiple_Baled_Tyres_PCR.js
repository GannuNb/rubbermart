...
import MultipleBaledTyresPCRImage from './images/MultipleBaledTyresPCR.jpeg'; // Ensure the image path is correct
        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-md-6">
              <img src={MultipleBaledTyresPCRImage} alt="Multiple Baled Tyres PCR" className="img-fluid" />
            </div>
            <div className="col-md-6">
              <h2 className="text-center">Multiple Baled Tyres PCR</h2>
              <p>
                Multiple Baled Tyres PCR (Pre-Crushed Rubber) is a versatile material derived from recycled tyres.
                It is commonly used in various industries such as construction and automotive, providing an eco-friendly and cost-efficient alternative.
              </p>
            </div>
          </div>
        </div>
