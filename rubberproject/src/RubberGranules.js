  ...
  useEffect(() => {
    const fetchApprovalDetails = async () => {
      try {
        ...
        console.error('Error fetching Rubber Granules data:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="mulch-page">
      ...
      <div className="hero-carousel">
        <Slider {...carouselSettings}>
          <div className="hero-slide">
            <img src={RubberGranulesImage} alt="Rubber Granules 1" className="hero-image" />
            <div className="hero-text">
              <h1>Rubber Granules / Crumb</h1>
              <p>
                Rubber Granules are made from recycled tyres and are used in various industrial
                and sports applications. They provide excellent durability, cushioning, and
                shock absorption.
              </p>
            </div>
          </div>
          <div className="hero-slide">
            <img src={RubberCrumSteelImage1} alt="Rubber Crumb" className="hero-image" />
            <div className="hero-text">
              <h1>Eco-Friendly and Sustainable</h1>
              <p>
                Made from 100% recycled materials, Rubber Granules are an environmentally friendly
                solution for playgrounds, turf infill, and flooring applications.
              </p>
            </div>
          </div>
        </Slider>
      ...
      <div className="related-categories container mt-5">
        ...
        <div className="related-grid">
          ...
          <Link to="/mulchPCR" className="related-card">
