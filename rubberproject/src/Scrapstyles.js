...
function Scrapstyles() {
      ...
      <div className="setter">
        ...
        <div className="about-us-section">
          <div className="about-us-content">
            ...
            Rubberscrapmart.com is an India's exclusive leading B2B marketplace dedicated to the buying, selling, and 
            trading of rubber scrap-derived products. Our platform connects recyclers, manufacturers, suppliers, and 
            buyers from all over India, promoting sustainability and innovation in the rubber industry.
            We Rubberacrapmart.com, is committed in creating a sustainable and profitable ecosystem for rubber waste and its recycled products.

            </p>
            <Link to="/AboutUsPage">
            <button className="request-demo">Learn More →</button></Link>
          </div>
        </div>
  ...
  <div className="cards-containerss">
    <div className="cardsel">
      ...
      <h3>Service Areas</h3>
      <p>
        We are serving across three major locations Mundra, Chennai, 
        and Nhavasheva specializing in the collection and recycling of rubber scrap materials, 
    ...
    <div className="cardsel">
      ...
      <p>
        We provide SCRAP PICKUP SERVICE, 
         buying all kinds of rubberscrap materials such as Pcr Mulch, Pcr Baled tyres, Pcr three-piece, Tbr baled tyres, Tbr three-piece,
          rubber granules/crumb, shreds, pyro oil, rubber crumb steel, and pyro steel.
      </p>
    </div>
    <div className="cardsel">
      ...
      <p>
        ...
        <div className="new-section">
          <div className="new-content">
            ...
            <Link to="/Productspage"><button className="buying-btn">BUY</button></Link>
              <Link to="/sell"><button className="selling-btn">SELL</button></Link>
            </div>
          </div>
