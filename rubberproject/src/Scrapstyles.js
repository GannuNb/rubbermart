...
function Scrapstyles() {
  ...
  useEffect(() => {
    // Intersection Observer to add class when element comes into view
  ...
  return (
   ...
   <div className="gif-wrapper">
    <img src={myGif} alt="A cool GIF" onClick={handleGifClick} />
  </div>
        ...
        {/* New Section */}
        <div className="new-section fade-up mb-0" ref={sectionRef}>
