  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        displayAlert(
          "Thank you for Creating Business Profile, WELCOME ONBOARD!",
          "success"
        );
        setProfileExists(true);
        navigate("/");
        ...
        displayAlert(
          `Failed to create business profile: ${response.data.message}`,
          "danger"
        );
      }
    } catch (error) {
        ...
        <div className="container">
          <div className="business-profile-container">
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 mb-3 text-black">
                <p>
                  <strong>Bill to Address:</strong> {profile.billAddress}
                </p>
              </div>
              <div className="col-12 col-md-6 mb-3 text-black">
                <p>
                  <strong>Ship to Address:</strong> {profile.shipAddress}
                </p>
              </div>
              <div className="col-12 mb-3 text-black">
                <p>
                  <strong>Intrested Products:</strong>{" "}
                  {profile.selectedProducts.join(", ")}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="row mb-4">
            <div className="col-md-6">
              <label htmlFor="companyName" className="form-label text-muted">
                Company Name
              </label>
              <input
                type="text"
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-6">
              <label htmlFor="gstNumber" className="form-label text-muted">
                GST Number
              </label>
              <input
                type="text"
          ...
          <div className="row mb-4">
            <div className="col-md-6">
              <label htmlFor="pan" className="form-label text-muted">
                PAN
              </label>
              <input
                type="text"
          ...
          <div className="row mb-4">
            <div className="col-md-6">
              <label htmlFor="billAddress" className="form-label text-muted">
                Bill to Address
              </label>
              <textarea
                className="form-control shadow-sm"
          ...
          <div className="row mb-4">
            <div className="col-md-6">
              <label htmlFor="gstCertificate" className="form-label text-muted">
            ...
            <div className="col-md-6">
              <label htmlFor="panCertificate" className="form-label text-muted">
          ...
          <div className="mb-4">
            <div className="form-check">
              <input
                ...
                required
              />
              <label htmlFor="terms" className="form-check-label text-black">
                I agree to the{" "}
                <a href="/TermsPage" target="_blank" rel="noopener noreferrer">
                  Terms and Conditions
                </a>
              </label>
            </div>
            {/* Short Preview of Terms and Conditions */}
            <div className="border p-3 mt-2 rounded bg-light">
              <p className="text-muted mb-1">
                By Creating Business Profile, you agree to our Terms and Conditions,
                including data privacy and business conduct.
              </p>
              <a href="/TermsPage" target="_blank" rel="noopener noreferrer">
                View More
              </a>
