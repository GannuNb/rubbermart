      ...
      <div className="about-header">
        <div className="container text-center py-5">
          ...
          <p className="lead text-white">
            Your One-Stop Marketplace for Rubber Scrap Derived Products
          </p>
        </div>
      </div>
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            ...
            <p className="section-description">
              <Link to="/" style={{ textDecoration: "none" }}>RubberScrapMart.com</Link> 
              {' '}is India's exclusive leading B2B marketplace dedicated to the buying, selling, and
              trading of rubber scrap-derived products. Our platform connects recyclers, manufacturers, 
              suppliers, and buyers from all over India, promoting sustainability and innovation in the rubber industry.
            </p>
            <p>
              <Link to="/" style={{ textDecoration: "none" }}>RubberScrapMart.com</Link> is committed to creating a sustainable and profitable 
              ecosystem for rubber waste and its recycled products. By leveraging cutting-edge technology and an extensive global network,
              we help businesses source high-quality reclaimed rubber materials, rubber scrap, rubber belt scrap, rubber granules,
              rubber crumb of different sizes, rubberized flooring, tire-derived products, and more.
            </p>
          </div>
          <div className="col-lg-6">
            <img 
              src={scrapImage} 
              alt="Rubber Products" 
              className="img-fluid imgmore rounded shadow-lg" 
            />
          </div>
        </div>
      </div>
      ...
      <div className="container py-5">
        <div className="row">
          <div className="col-lg-6">
            ...
            <p className="section-description">
              Our main aim is to bridge the gap between rubber waste suppliers, recyclers, and manufacturers by providing a transparent, 
              efficient, and eco-conscious trading platform.
            </p>
          </div>
          <div className="col-lg-6">
      ...
      <div className="join-us-section py-5 bg-dark text-white">
        <div className="container text-center">
          ...
          <p className="join-us-description mb-4">
            Whether you're a rubber recycler, manufacturer, or industrial buyer, RubberScrapMart.com is your one-stop destination 
            for all rubber scrap and recycled product needs.
          </p>
          ...
          {isLoggedIn ? (
            <Link to="/" className="btn btn-light btn-lg join-us-btn shadow-lg">
              Explore More
            </Link>
          ) : (
            <Link to="/signup" className="btn btn-light btn-lg join-us-btn shadow-lg">
              Sign Up Now
            </Link>
          )}
        </div>
