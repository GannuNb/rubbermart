...
import ShreddsImage2 from './images/Shredds.jpeg'; // Optional secondary image
import './Mulch.css';
  ...
  useEffect(() => {
    const fetchApprovalDetails = async () => {
      try {
        ...
        console.error('Error fetching Shredds data:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="hero-carousel">
        <Slider {...carouselSettings}>
          <div className="hero-slide">
            <img src={ShreddsImage} alt="Shredds 1" className="hero-image" />
            <div className="hero-text">
              <h1>Shreds</h1>
              <p>
                <strong>Shreds</strong> are finely processed recycled rubber materials widely used in
                road construction, landscaping, and various industrial applications. They offer
                durability, cost-effectiveness, and sustainability by reducing landfill waste and
                promoting eco-friendly practices.
              </p>
            </div>
          </div>
          <div className="hero-slide">
            <img src={ShreddsImage2 || ShreddsImage} alt="Shredds 2" className="hero-image" />
            <div className="hero-text">
              <h1>Eco-Friendly Rubber Solution</h1>
              <p>
                Shreds provide a green alternative to traditional materials, improving performance
                while contributing to environmental sustainability. Ideal for use in tire recycling
                and rubber-based manufacturing.
              </p>
            </div>
          </div>
        </Slider>
...
<div className="related-categories container mt-5">
  ...
  <div className="related-grid">
    ...
    <Link to="/threepiecetbr" className="related-card">
      <img src={ThreePiecePCRImage} alt="Shreds" />
      <p>Three Piece PCR</p>
    </Link>
