...
const BuyerTransportPaymentSection = ({ shipment, order }) => {
  ...
  return (
    <div className={styles.paymentCard} style={{ padding: "0", overflow: "hidden" }}>
      {/* HEADER BAR (ACTS AS ACCORDION TRIGGER) */}
      <div 
        className={styles.paymentHeaderAccordion}
        onClick={() => setIsOpen(!isOpen)}
        style={{ cursor: "pointer", userSelect: "none" }}
      >
        <div className={styles.paymentHeader} style={{ margin: "0", width: "100%" }}>
