...
import { GiRecycle, GiCircularSaw, GiFactory } from 'react-icons/gi';
...
const TyreScrap = () => {
    ...
    const allProducts = [
        { id: 1, name: "Baled Tyres PCR", category: "Baled", image: TyreHero, featured: false, desc: "Passenger Car Radial, high-density baling for export." },
        { id: 2, name: "Baled Tyres TBR", category: "Baled", image: TyreHero, featured: true, desc: "Truck/Bus Radial. Maximum yield for Pyrolysis plants." },
        { id: 3, name: "Three Piece PCR", category: "Cut", image: TyreHero, featured: false, desc: "Car tyres cut into three sections for easy reactor loading." },
        { id: 4, name: "Three Piece TBR", category: "Cut", image: TyreHero, featured: true, desc: "Truck tyres cut for optimized shipping weight efficiency." },
        { id: 5, name: "Tyre Shreds", category: "Processed", image: TyreHero, featured: false, desc: "TDF-ready shredded rubber pieces for industrial fuel." },
        { id: 6, name: "Rubber Granules", category: "Processed", image: TyreHero, featured: true, desc: "99% pure wire-free crumb rubber for manufacturing." },
        { id: 7, name: "Mulch PCR", category: "Processed", image: TyreHero, featured: false, desc: "Safety-grade mulch for landscaping and playgrounds." }
    ];
                ...
                <div className={styles.container}>
                    <div className={styles.contentSplit}>
                        ...
                        <div className={styles.ctaBox}>
                            ...
                            {/* Changed class to ctaBtn for specific neat styling */}
