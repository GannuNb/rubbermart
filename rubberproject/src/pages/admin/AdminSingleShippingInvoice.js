 ...
 const shipment =
  ...
  if (!shipment || !order) {
    return (
      <div className={styles.container}>
        <div className={styles.emptyState}>Shipment details not found</div>
      </div>
    );
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.backSection}>
        ...
        <h2 className={styles.sectionTitle}>
          ...
          <div className={styles.idRow}>
            <span>Order Id: {order?.orderId || orderId}</span>
            {/* <span>
      ...
      <AdminShipmentTopCard shipment={shipment} order={order} />

      {/* PRODUCT CARD */}

      <AdminShipmentProductCard shipment={shipment} order={order} />
      ...
      <AdminShipmentActionsCard shipment={shipment} order={order} />
    </div>
  );
};
