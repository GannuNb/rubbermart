  ...
  useEffect(() => {
    const fetchApprovalDetails = async () => {
      try {
        ...
        console.error('Error fetching Three Piece TBR data:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="hero-carousel">
        <Slider {...carouselSettings}>
          <div className="hero-slide">
            <img src={ThreePieceTBRImage} alt="Three Piece TBR 1" className="hero-image" />
            <div className="hero-text">
              <h1>Three Piece TBR</h1>
              <p>
                <strong>Three Piece TBR</strong> is a high-quality, heavy-duty tyre type designed for
                trucks and buses. Known for its superior strength and long-lasting durability, this product
                provides exceptional performance under high-load conditions.
              </p>
            </div>
          </div>
          <div className="hero-slide">
            <img src={tbr2} alt="Three Piece TBR 2" className="hero-image" />
            <div className="hero-text">
              <h1>Durable and Reliable</h1>
              <p>
                Designed for challenging terrains and long-haul applications, Three Piece TBR tyres
                deliver unmatched stability and traction, reducing downtime and ensuring safety.
              </p>
            </div>
          </div>
        </Slider>
